...
/**
 * Footer style Win Agro : fond noir-vert, logo avec light beam,
 * 4 colonnes (Brand / Services / Produits / Entreprise), bordure top verte.
 */
    ...
    <footer className="bg-noir-vert text-gray-300 border-t-4 border-primary-green relative overflow-hidden">
      ...
      <div className="container-x py-16 relative z-10">
            ...
            <ul className="flex items-center gap-4">
              ...
              <li>
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  className="w-10 h-10 rounded-full bg-whatsapp/20 hover:bg-whatsapp text-white hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110"
                >
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <nav aria-label="Entreprise">
            ...
            <ul className="space-y-4 font-sans text-sm">
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${siteConfig.phone.replace(/\s/g, "")}`} className="hover:text-accent-yellow transition-colors font-bold">
                  {siteConfig.phone}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-accent-yellow">✉️</span>
                <a href={`mailto:${siteConfig.email}`} className="hover:text-accent-yellow transition-colors">
                  {siteConfig.email}
                </a>
              </li>
              ...
              <li className="pt-4 border-t border-primary-green/10 space-y-3">
        ...
        <div className="border-t border-primary-green/10 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-400">
          ...
          <p className="font-sans font-bold text-accent-yellow">
            Que la lumière soit ✦
          </p>
        </div>
      </div>
