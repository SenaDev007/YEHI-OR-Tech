 ...
 * fond noir-profond + halos or/blue + cercles flottants + badge pulse-slow or +
 * titre serif avec underline or animée + boutons rounded-full avec btn-shimmer.
 */
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        ...
        {/* Cercles flottants — style Win Agro avec or */}
      ...
      <div className="container-x relative z-10 w-full">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          {/* Titre H1 avec underline or animée — style Win Agro */}
