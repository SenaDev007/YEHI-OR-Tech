...
/**
 * Carte projet portfolio style Win Agro adaptée palette YEHI OR Tech.
 */
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-4 p-6">
        <div>
          ...
          <h3 className="mt-2 font-serif text-2xl font-bold text-blanc-creme transition-colors duration-300 group-hover:text-or">
            {project.title}
          </h3>
        </div>
